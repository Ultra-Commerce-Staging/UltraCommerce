 ...
 * #L%
 */
package com.ultracommerce.test.common.context.override.importer;
...
public class DuplicateImportConfigurationTest {
    ...
    static class OtherConfiguration {
        ...
        /**
         * This will fail to override the ucPasswordEncoder that is imported via the EnableAutoConfigurationForImportTest
         */
        @Bean
        public PasswordEncoder ucPasswordEncoder() {
            return new BCryptPasswordEncoder();
        }

        @Bean
        public ObjectMapper ucObjectMapper() {
