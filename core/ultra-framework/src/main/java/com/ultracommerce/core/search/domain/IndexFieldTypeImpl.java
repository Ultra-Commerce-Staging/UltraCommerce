...
import com.ultracommerce.common.presentation.*;
...
@Table(name = "UC_INDEX_FIELD_TYPE")
...
public class IndexFieldTypeImpl implements IndexFieldType, Serializable {
    ...
    @GenericGenerator(
            ...
            parameters = {
                    ...
                    @Parameter(name="entity_name", value="com.ultracommerce.core.search.domain.IndexFieldTypeImpl")
            }
    )
    ...
    @AdminPresentation(friendlyName = "IndexFieldTypeImpl_fieldType", group = "IndexFieldTypeImpl_description", order = 4, prominent = true, gridOrder = 4,
            ...
            ultraEnumeration = "com.ultracommerce.core.search.domain.solr.FieldType",
