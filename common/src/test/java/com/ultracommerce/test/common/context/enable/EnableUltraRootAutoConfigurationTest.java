...
import com.ultracommerce.common.config.EnableUltraRootAutoConfiguration;
...
public class EnableUltraRootAutoConfigurationTest {

    @Configuration
    @EnableUltraRootAutoConfiguration
