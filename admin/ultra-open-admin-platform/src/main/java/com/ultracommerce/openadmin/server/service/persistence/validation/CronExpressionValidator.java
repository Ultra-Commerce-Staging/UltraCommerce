...
import com.ultracommerce.common.util.UCCronUtils;
 ...
 */
@Component("ucCronExpressionValidator")
public class CronExpressionValidator extends ValidationConfigurationBasedPropertyValidator {
    ...
    public PropertyValidationResult validate(Entity entity,
        ...
        return new PropertyValidationResult(UCCronUtils.isValidExpression(value), INVALID_EXPRESSION);
    }
