...
import com.ultracommerce.openadmin.server.service.persistence.validation.RegexPropertyValidator;
 ...
 */
@Component("ucDynamicFieldPersistenceHandlerHelper")
public class DynamicFieldPersistenceHandlerHelper {
    ...
    public Property buildDynamicProperty(FieldDefinition definition, Class<?> inheritedType) {
        ...
        fieldMetadata.setUltraEnumeration("");
