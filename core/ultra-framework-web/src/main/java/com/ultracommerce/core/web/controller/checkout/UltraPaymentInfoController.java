 ...
 */
public class UltraPaymentInfoController extends AbstractCheckoutController {
     ...
     *
     * Note: this default Ultra implementation will create a CustomerPayment if one does not exist,
