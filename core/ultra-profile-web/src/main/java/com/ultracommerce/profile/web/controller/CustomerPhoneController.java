...
import com.ultracommerce.profile.core.service.CustomerPhoneService;
import com.ultracommerce.profile.web.controller.validator.CustomerPhoneValidator;
import com.ultracommerce.profile.web.controller.validator.PhoneValidator;
import com.ultracommerce.profile.web.core.CustomerState;
import com.ultracommerce.profile.web.core.model.PhoneNameForm;
import com.ultracommerce.profile.web.core.util.PhoneFormatter;
 ...
 * @author sconlon
 */
@Controller("ucCustomerPhoneController")
...
public class CustomerPhoneController {
    ...
    @Resource(name="ucCustomerPhoneService")
    private CustomerPhoneService customerPhoneService;
    @Resource(name="ucCustomerPhoneValidator")
    private CustomerPhoneValidator customerPhoneValidator;
    @Resource(name="ucCustomerState")
    private CustomerState customerState;
    @Resource(name="ucEntityConfiguration")
    private EntityConfiguration entityConfiguration;
    @Resource(name="ucPhoneFormatter")
    private PhoneFormatter phoneFormatter;
    @Resource(name="ucPhoneValidator")
    ...
    public PhoneNameForm initPhoneNameForm(HttpServletRequest request, Model model) {
        ...
        form.setPhone((Phone) entityConfiguration.createEntityInstance("com.ultracommerce.profile.core.domain.Phone"));
    ...
    public String savePhone(@ModelAttribute("phoneNameForm")
        ...
        if (!errors.hasErrors()) {
            CustomerPhone customerPhone = (CustomerPhone) entityConfiguration.createEntityInstance("com.ultracommerce.profile.core.domain.CustomerPhone");
