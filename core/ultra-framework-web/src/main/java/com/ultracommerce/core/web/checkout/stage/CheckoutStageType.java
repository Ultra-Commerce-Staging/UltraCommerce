 ...
 * #L%
 */
package com.ultracommerce.core.web.checkout.stage;
 ...
 */
public class CheckoutStageType implements Serializable, UltraEnumerationType, Comparable<CheckoutStageType> {
