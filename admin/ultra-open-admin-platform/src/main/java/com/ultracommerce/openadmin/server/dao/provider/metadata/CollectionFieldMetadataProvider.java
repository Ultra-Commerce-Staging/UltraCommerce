...
import com.ultracommerce.common.presentation.override.AdminPresentationCollectionOverride;
 ...
 * @author Jeff Fischer
 */
@Component("ucCollectionFieldMetadataProvider")
@Scope("prototype")
public class CollectionFieldMetadataProvider extends AdvancedCollectionFieldMetadataProvider {
    ...
    protected void buildCollectionMetadata(Class<?> parentClass, 
        ...
        com.ultracommerce.openadmin.dto.OperationTypes dtoOperationTypes = new com.ultracommerce.openadmin.dto.OperationTypes(OperationType.BASIC, OperationType.BASIC, OperationType.BASIC, OperationType.BASIC, OperationType.BASIC);
