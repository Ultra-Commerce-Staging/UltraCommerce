...
@Table(name = "UC_DISC_ITEM_FEE_PRICE")
...
public class DiscreteOrderItemFeePriceImpl implements DiscreteOrderItemFeePrice  {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="com.ultracommerce.core.order.domain.DiscreteOrderItemFeePriceImpl")
        }
    )
    ...
    public void checkCloneable(DiscreteOrderItemFeePrice discreteFeePrice) throws CloneNotSupportedException, SecurityException, NoSuchMethodException {
        ...
        if (cloneMethod.getDeclaringClass().getName().startsWith("com.ultracommerce") && !discreteFeePrice.getClass().getName().startsWith("com.ultracommerce")) {
