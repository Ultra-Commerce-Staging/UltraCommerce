 ...
 */
public class UCCollectionUtils {
    ...
    public static <T extends Collection> T createChangeAwareCollection(final WorkOnChange work, final Collection original) {
        T proxy = (T) Proxy.newProxyInstance(UCCollectionUtils.class.getClassLoader(), ClassUtils.getAllInterfacesForClass(original.getClass()), new InvocationHandler() {
            @Override
