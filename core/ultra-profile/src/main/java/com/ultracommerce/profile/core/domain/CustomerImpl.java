...
import com.ultracommerce.common.audit.AuditExcludeFieldValue;
...
@Table(name = "UC_CUSTOMER")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "ucCustomerElements")
