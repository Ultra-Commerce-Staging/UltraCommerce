 ...
 * ordering semantics. This is generally only used within the Ultra Framework and supporting modules. This assumes that the location is on the
 ...
 * 
 * <pre>
 * com.ultracommerce.common.config.FrameworkCommonClasspathPropertySource=com.ultracommerce.common.config.UltraCommonPropertySource
 * </pre>
 * 
 * <p>
 * Any properties resolved by these classes have a lower precedence than any {@link UltraSharedOverrideProfileAwarePropertySource}. However, these have a higher
 ...
 * @see {@link UltraSharedOverrideProfileAwarePropertySource}
 * @see {@link UltraEnvironmentConfiguringApplicationListener}
 */
public interface FrameworkCommonClasspathPropertySource {

    /**
     * All of the property configurations registered by the core framework (e.g. ultra-framework, ultra-common, ultra-open-admin-platform, etc)
     * have this ordering.
     * 
     ...
     */
    public static final int ULTRA_COMMON_ORDER = -8000;
