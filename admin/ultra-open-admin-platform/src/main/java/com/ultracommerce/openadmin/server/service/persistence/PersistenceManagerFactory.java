 ...
 * @author Jeff Fischer
 */
@Service("ucPersistenceManagerFactory")
public class PersistenceManagerFactory implements ApplicationContextAware {
    ...
    public static final String DEFAULTPERSISTENCEMANAGERREF = "ucPersistenceManager";
    ...
    /**
     * This method produces a {@link PersistenceManager} with a ucPU-based standardEntityManager.
