...
public class OfferInfoImpl implements OfferInfo {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="com.ultracommerce.core.offer.domain.OfferInfoImpl")
        }
    )
    ...
    @CollectionTable(name="UC_OFFER_INFO_FIELDS", joinColumns=@JoinColumn(name="OFFER_INFO_FIELDS_ID"))
    @BatchSize(size = 50)
