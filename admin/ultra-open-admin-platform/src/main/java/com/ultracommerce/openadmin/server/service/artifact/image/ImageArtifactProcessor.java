...
import com.ultracommerce.openadmin.server.service.artifact.ArtifactProcessor;
import com.ultracommerce.openadmin.server.service.artifact.image.effects.chain.EffectsManager;
 ...
 */
@Service("ucImageArtifactProcessor")
public class ImageArtifactProcessor implements ArtifactProcessor {

    @Resource(name="ucImageEffectsManager")
