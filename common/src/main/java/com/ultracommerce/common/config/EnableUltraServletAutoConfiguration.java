...
import com.ultracommerce.common.config.EnableUltraServletAutoConfiguration.UltraServletAutoConfigurationOverrides;
 ...
 * <p>
 * The same rules apply here as with {@link EnableUltraAutoConfiguration} but this is for only the servlet-level Ultra beans
 ...
 * @see EnableUltraRootAutoConfiguration
...
@Import({
    ...
    UltraServletAutoConfigurationOverrides.class
})
public @interface EnableUltraServletAutoConfiguration {
    ...
    @ImportResource(locations = {
            "classpath*:/uc-config/framework/uc-*-applicationContext-servlet.xml",
            "classpath*:/uc-config/early/uc-*-applicationContext-servlet.xml",
            "classpath*:/uc-config/uc-*-applicationContext-servlet.xml",
            "classpath*:/uc-config/late/uc-*-applicationContext-servlet.xml"
    }, reader = FrameworkXmlBeanDefinitionReader.class)
    class UltraServletAutoConfiguration {}
    
    @ImportResource("classpath:/override-contexts/autoconfiguration-servlet-overrides.xml")
    class UltraServletAutoConfigurationOverrides { }
}
