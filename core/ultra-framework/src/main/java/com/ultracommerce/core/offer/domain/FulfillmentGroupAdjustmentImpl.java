...
public class FulfillmentGroupAdjustmentImpl implements FulfillmentGroupAdjustment, CurrencyCodeIdentifiable {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="com.ultracommerce.core.offer.domain.FulfillmentGroupAdjustmentImpl")
        }
    )
    ...
    public Money getValue() {
        return value == null ? null : UltraCurrencyUtils.getMoney(value, getFulfillmentGroup().getOrder().getCurrency());
    }
