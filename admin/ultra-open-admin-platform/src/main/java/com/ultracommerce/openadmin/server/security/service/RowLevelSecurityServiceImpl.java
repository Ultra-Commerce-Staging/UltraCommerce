...
/**
 * @see com.ultracommerce.openadmin.server.security.service.RowLevelSecurityService
 * @author Phillip Verheyden (phillipuniverse)
 * @author Jeff Fischer
 */
@Service("ucRowLevelSecurityService")
public class RowLevelSecurityServiceImpl implements RowLevelSecurityService, ExceptionAwareRowLevelSecurityProvider {
    ...
    @Resource(name = "ucRowLevelSecurityProviders")
