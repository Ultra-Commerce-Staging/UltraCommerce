 ...
 */
public interface UltraCommonAddressValidatorExtensionHandler extends ExtensionHandler {

    public ExtensionResultStatusType validate(UltraFormType formType, Address address, Errors errors);
