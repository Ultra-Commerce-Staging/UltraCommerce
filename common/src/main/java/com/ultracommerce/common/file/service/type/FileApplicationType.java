...
package com.ultracommerce.common.file.service.type;
...
/**
 * Any module within the UC framework that needs to store and retrieve files from a remote storage such as
 ...
 * @author bpolster
 */
public class FileApplicationType implements Serializable, UltraEnumerationType {
