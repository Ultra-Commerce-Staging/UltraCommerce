 ...
 * #L%
 */
package com.ultracommerce.common.id.service;
...
import com.ultracommerce.common.id.dao.IdGenerationDao;
import com.ultracommerce.common.id.domain.IdGeneration;
import org.springframework.stereotype.Service;

@Service("ucIdGenerationService")
public class IdGenerationServiceImpl implements IdGenerationService {
    ...
    @Resource(name="ucIdGenerationDao")
