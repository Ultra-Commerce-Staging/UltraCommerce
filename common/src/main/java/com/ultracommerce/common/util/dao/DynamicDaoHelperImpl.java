...
import com.ultracommerce.common.exception.ProxyDetectionException;
...
public class DynamicDaoHelperImpl implements DynamicDaoHelper {
    ...
    public static Class<?> getNonProxyImplementationClassIfNecessary(Class<?> candidate) {
        ...
        //TODO Although unusual, there are other proxy types in Hibernate than just javassist proxies (Ultra defaults to javassist).
