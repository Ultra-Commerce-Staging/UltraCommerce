...
import com.ultracommerce.openadmin.web.rulebuilder.enums.RuleBuilderEnumOptionsExtensionListener;
 ...
 * @since 4.0
 */
@Component("ucRuleBuilderOptionResourceResolver")
public class RuleBuilderOptionsResourceResolver implements ResourceResolver {
    ...
    @javax.annotation.Resource(name = "ucRuleBuilderEnumOptionsExtensionListeners")
