...
import com.ultracommerce.common.sitemap.wrapper.SiteMapIndexWrapper;
import com.ultracommerce.common.sitemap.wrapper.SiteMapURLSetWrapper;
import com.ultracommerce.common.sitemap.wrapper.SiteMapURLWrapper;
import com.ultracommerce.common.sitemap.wrapper.SiteMapWrapper;
...
public class SiteMapBuilder {
    ...
    protected void persistIndexedSiteMap() {
        ...
        for (String fileName : indexedFileNames) {
            ...
            String fileLoc = null;
            if (gzipSiteMapFiles) {
                fileLoc = UltraFileUtils.appendUnixPaths(baseUrl, fileName + ".gz");
            } else {
                fileLoc = UltraFileUtils.appendUnixPaths(baseUrl, fileName);
            }
