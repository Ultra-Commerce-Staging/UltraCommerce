 ...
 * @author Jacob Mitash
 */
@Component("ucResourcePreloadProcessor")
...
public class ResourcePreloadProcessor extends AbstractResourceProcessor {
    ...
    @Override
    protected UltraTemplateModel buildModelBundled(List<String> attributeFiles, ResourceTagAttributes resourceTagAttributes, UltraTemplateContext context) {
        ...
        UltraTemplateElement bundlePreload = buildPreloadElement(bundleUrl, context);
    ...
    @Override
    protected UltraTemplateModel buildModelUnbundled(List<String> attributeFiles, ResourceTagAttributes resourceTagAttributes, UltraTemplateContext context) {
        UltraTemplateModel model = context.createModel();

        final List<String> files = postProcessUnbundledFileList(attributeFiles, resourceTagAttributes, context);

        for (final String file : files) {
            UltraTemplateElement element = buildPreloadElement(file, context);
     ...
     */
    protected UltraTemplateElement buildPreloadElement(String href, UltraTemplateContext context) {
