 ...
 * {@link com.ultracommerce.common.TimeDTO time}, or {@link com.ultracommerce.common.RequestDTO request}
 *
 * @see com.ultracommerce.cms.web.structure.DisplayContentTag
 * @see com.ultracommerce.cms.structure.service.StructuredContentServiceImpl#evaluateAndPriortizeContent(java.util.List, int, java.util.Map)
 * @author jfischer
 * @author bpolster
 *
 */
