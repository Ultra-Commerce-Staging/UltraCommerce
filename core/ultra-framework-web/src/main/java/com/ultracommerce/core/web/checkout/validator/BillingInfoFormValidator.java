...
@Component("ucBillingInfoFormValidator")
public class BillingInfoFormValidator extends UltraCommonAddressValidator implements Validator {
    ...
    public void validate(Object obj, Errors errors) {
        ...
        super.validate(UltraFormType.BILLING_FORM, billingInfoForm.getAddress(), errors);
    }
}
