 ...
 * @author jfischer
 */
public class ProductType implements Serializable, UltraEnumerationType {

    private static final long serialVersionUID = 1L;

    private static final Map<String, ProductType> TYPES = new LinkedHashMap<String, ProductType>();

    public static final ProductType PRODUCT  = new ProductType("com.ultracommerce.core.catalog.domain.Product", "Normal Product");
    public static final ProductType BUNDLE  = new ProductType("com.ultracommerce.core.catalog.domain.ProductBundle", "Product Bundle");
