 ...
 */
@Component("ucRecordOfferUsageActivity")
public class RecordOfferUsageActivity extends BaseActivity<ProcessContext<CheckoutSeed>> {
    ...
    @Autowired
    public RecordOfferUsageActivity(@Qualifier("ucRecordOfferUsageRollbackHandler") RecordOfferUsageRollbackHandler rollbackHandler) {
        setOrder(ORDER);
    ...
    protected List<OfferAudit> saveOfferIds(Set<Offer> offers, Map<Offer, OfferCode> offerToCodeMapping, Order order) {
        ...
        for (Offer offer : offers) {
            ...
            audit.setAccountId(order.getUltraAccountId());
