...
public class TransactionUtils {
    ...
    /**
     * Intended for use in all @Transactional definitions that operate against the <pre>ucPU</pre> persistence unit. For instance:
     * <pre>@Transactional(TransactionUtils.DEFAULT_TRANSACTION_MANAGER)</pre>
     */
    public static final String DEFAULT_TRANSACTION_MANAGER = "ucTransactionManager";

    /**
     * Intended for use in all @Transactional definitions that operate against the <pre>ucEventPU</pre> persistence unit. For instance:
     * <pre>@Transactional(TransactionUtils.EVENT_TRANSACTION_MANAGER)</pre>
     */
    public static final String EVENT_TRANSACTION_MANAGER = "ucTransactionManagerEventInfo";

    /**
     * Intended for use in all @Transactional definitions that operate against the <pre>ucSecurePU</pre> persistence unit. For instance:
     * <pre>@Transactional(TransactionUtils.SECURE_TRANSACTION_MANAGER)</pre>
     */
    public static final String SECURE_TRANSACTION_MANAGER = "ucTransactionManagerSecureInfo";
