...
import com.ultracommerce.common.util.dao.HibernateMappingProvider;
 ...
 * @author Jeff Fischer
 */
@Component("ucDefaultFieldMetadataProvider")
@Scope("prototype")
public class DefaultFieldMetadataProvider extends BasicFieldMetadataProvider {
    ...
    public MetadataProviderResponse addMetadataFromMappingData(AddMetadataFromMappingDataRequest addMetadataFromMappingDataRequest,
        ...
        if (SupportedFieldType.ULTRA_ENUMERATION.equals(addMetadataFromMappingDataRequest.getType())) {
            try {
                setupUltraEnumeration(fieldMetadata.getUltraEnumeration(), fieldMetadata,
