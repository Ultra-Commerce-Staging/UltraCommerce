 ...
 * </p>
 * Setup inside a Ultra Commerce module is generally performed in a manner similar to this example:
 * {@code
      <bean id="ucCommonConditionalDirectCopyTransformerMember" class="com.ultracommerce.common.weave.ConditionalDirectCopyTransformMemberDto">
         <property name="templateTokens">
             <util:constant static-field="com.ultracommerce.common.extensibility.jpa.copy.DirectCopyTransformTypes.MULTITENANT_SITE"/>
         </property>
         <property name="conditionalProperty" value="enable.site.map.mt.disc"/>
     </bean>

     <bean id="ucCommonConditionalDirectCopyTransformers" class="org.springframework.beans.factory.config.MapFactoryBean">
         <property name="sourceMap">
             <map>
                 <entry key="com.ultracommerce.common.sitemap.domain.SiteMapGeneratorConfigurationImpl" value-ref="ucCommonConditionalDirectCopyTransformerMember"/>
             </map>
         </property>
     </bean>

     <bean class="com.ultracommerce.common.extensibility.context.merge.EarlyStageMergeBeanPostProcessor">
         <property name="collectionRef" value="ucCommonConditionalDirectCopyTransformers"/>
         <property name="targetRef" value="ucConditionalDirectCopyTransformers"/>
     </bean>
 * }
 * The goal is to add configuration for one or more entities and then add that configuration to the "ucConditionalDirectCopyTransformers" map in
