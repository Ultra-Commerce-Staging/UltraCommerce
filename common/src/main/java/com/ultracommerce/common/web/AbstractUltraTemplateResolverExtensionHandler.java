 ...
 * @author bpolster
 */
public abstract class AbstractUltraTemplateResolverExtensionHandler extends AbstractExtensionHandler 
        implements UltraTemplateViewResolverExtensionHandler {
