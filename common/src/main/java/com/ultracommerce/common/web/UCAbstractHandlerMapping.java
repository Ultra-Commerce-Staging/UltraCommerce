 ...
 * UC specific HandlerMappings.
 * 
 * Always returns null from defaultHandlerMapping 
 * 
 * @author bpolster
 */
public abstract class UCAbstractHandlerMapping extends AbstractHandlerMapping {
    ...
    /**
     * Returns the controllerName if set or "ucPageController" by default.
     * @return
     */
