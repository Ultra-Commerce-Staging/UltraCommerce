...
import com.ultracommerce.common.enumeration.domain.DataDrivenEnumerationImpl;
...
public class FieldDefinitionImpl implements FieldDefinition, ProfileEntity {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="com.ultracommerce.cms.field.domain.FieldDefinitionImpl")
        }
    )
    ...
    @AdminPresentation(fieldType = SupportedFieldType.ULTRA_ENUMERATION, 
        ultraEnumeration = "com.ultracommerce.common.presentation.client.DynamicSupportedFieldType",
