 ...
 * #L%
 */
package com.ultracommerce.common.crossapp.service;
...
public interface CrossAppAuthService {
    ...
    public static String AUTH_FROM_ADMIN_URL_PARAM = "ucAuthToken";
    public static String AUTH_FROM_ADMIN_SESSION_VAR = "ucAuthedFromAdmin";
