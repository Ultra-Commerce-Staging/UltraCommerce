 ...
 * @author bpolster
 */
@Service("ucSystemPropertiesService")
public class SystemPropertiesServiceImpl implements SystemPropertiesService{
    ...
    protected static final String SYSTEM_PROPERTY_CACHE_NAME = "ucSystemPropertyElements";
    ...
    @Resource(name="ucSystemPropertiesDao")
    protected SystemPropertiesDao systemPropertiesDao;

    @Resource(name = "ucSystemPropertyServiceExtensionManager")
    ...
    public String resolveSystemProperty(String name) {
        ...
        if (UltraRequestContext.getUltraRequestContext() == null
            || UltraRequestContext.getUltraRequestContext().getSandBox() == null) {
