 ...
 * #L%
 */
/* Utility methods provided by Ultra Commerce */
var UC = (function($) {
    
    var redirectUrlDiv = "uc-redirect-url",
        extraDataDiv   = "uc-extra-data",
        internalDataDiv   = "uc-internal-data",
        preAjaxCallbackHandlers = [],
        internalDataHandlers = [],
        servletContext = "//UC-SERVLET-CONTEXT",
        siteBaseUrl = "//UC-SITE-BASEURL";
    ...
    function get(options, callback) {
        ...
        options.type = 'GET';
        return UC.ajax(options, callback);
    }
    ...
    addPreAjaxCallbackHandler(function($data) {
        return UC.redirectIfNecessary($data);
    });
