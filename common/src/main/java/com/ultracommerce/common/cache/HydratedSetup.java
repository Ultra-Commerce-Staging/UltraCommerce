...
import com.ultracommerce.common.cache.engine.HydratedAnnotationManager;
import com.ultracommerce.common.cache.engine.HydratedCacheManager;
import com.ultracommerce.common.cache.engine.HydrationDescriptor;
...
public class HydratedSetup {
    ...
    public static EntityManager retrieveBoundEntityManager() {
        ...
        throw new RuntimeException("Unable to restore skus from hydrated cache. Please make sure that the OpenEntityManagerInViewFilter is configured in web.xml for the ucPU persistence unit.");
    }
}
