 ...
 * 
 * Add:<br/>
 *  {@code ucPU.hibernate.hbm2ddl.import_files_sql_extractor=com.ultracommerce.common.util.sql.importsql.DemoPostgresSingleLineSqlCommandExtractor
 *  ucEventPU.hibernate.hbm2ddl.import_files_sql_extractor=com.ultracommerce.common.util.sql.importsql.DemoPostgresSingleLineSqlCommandExtractor}<br>
 *  
