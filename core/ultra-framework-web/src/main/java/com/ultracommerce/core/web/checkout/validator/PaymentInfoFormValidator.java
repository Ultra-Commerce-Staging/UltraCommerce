...
@Component("ucPaymentInfoFormValidator")
public class PaymentInfoFormValidator extends UltraCommonAddressValidator implements Validator {
    ...
    public void validate(Object obj, Errors errors) {
        ...
        super.validate(UltraFormType.PAYMENT_FORM, paymentInfoForm.getAddress(), errors);
    }
}
