 ...
 */
@Component("ucSimpleMappingExceptionResolver")
public class UltraSimpleMappingExceptionResolver extends SimpleMappingExceptionResolver {

    private static final Log LOG = LogFactory.getLog(UltraSimpleMappingExceptionResolver.class);
