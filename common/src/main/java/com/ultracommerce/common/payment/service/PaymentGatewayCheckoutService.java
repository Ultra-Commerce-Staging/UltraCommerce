 ...
 * {@link ocom.ultracommerce.core.payment.service.DefaultPaymentGatewayCheckoutService}. This is designed as
 * a generic contract for allowing payment modules to add payments to an order represented in Ultra while still
 * staying decoupled from any of the Ultra core framework concepts.</p>
 * 
...
public interface PaymentGatewayCheckoutService {
     ...
     * @return a unique ID of the payment as it is saved in the core commerce engine. If using Ultra core,
     * this ID can be used to retrieve the payment on the Ultra side for other methods like {@link #markPaymentAsInvalid(Long)}
