...
@Entity
@Table(name = "UC_OFFER_PRICE_DATA")
...
@SQLDelete(sql="UPDATE UC_OFFER_PRICE_DATA SET ARCHIVED = 'Y' WHERE OFFER_PRICE_DATA_ID = ?")
@DirectCopyTransform({
...
public class OfferPriceDataImpl implements OfferPriceData {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="com.ultracommerce.core.offer.domain.OfferPriceDataImpl")
        }
    )
    ...
    @AdminPresentation(
            ...
            ultraEnumeration = "com.ultracommerce.core.offer.service.type.OfferPriceDataIdentifierType",
