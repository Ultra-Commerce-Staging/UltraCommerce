...
public class OfferOfferRuleXrefImpl implements OfferOfferRuleXref, SimpleRule {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="com.ultracommerce.core.offer.domain.OfferOfferRuleXrefImpl")
        }
    )
    ...
    @JoinColumn(name = "UC_OFFER_OFFER_ID")
