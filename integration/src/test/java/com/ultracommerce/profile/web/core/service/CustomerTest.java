...
import com.ultracommerce.common.id.domain.IdGenerationImpl;
import com.ultracommerce.profile.core.domain.Customer;
import com.ultracommerce.profile.core.service.CustomerService;
import com.ultracommerce.profile.dataprovider.CustomerDataProvider;
...
public class CustomerTest extends TestNGSiteIntegrationSetup {
    ...
    public void createCustomerIdGeneration() {
        IdGenerationImpl gen = em.find(IdGenerationImpl.class, "com.ultracommerce.profile.core.domain.Customer");
        if (gen == null) {
            IdGeneration idGeneration = new IdGenerationImpl();
            idGeneration.setType("com.ultracommerce.profile.core.domain.Customer");
