 ...
 */
@Entity
@Table(name = "UC_PAGE_ITEM_CRITERIA")
...
public class PageItemCriteriaImpl implements PageItemCriteria, ProfileEntity {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="com.ultracommerce.cms.page.domain.PageItemCriteriaImpl")
        }
    )
    ...
    @JoinTable(name = "UC_QUAL_CRIT_PAGE_XREF", joinColumns = @JoinColumn(name = "PAGE_ITEM_CRITERIA_ID"), inverseJoinColumns = @JoinColumn(name = "PAGE_ID"))
    protected Page page;
