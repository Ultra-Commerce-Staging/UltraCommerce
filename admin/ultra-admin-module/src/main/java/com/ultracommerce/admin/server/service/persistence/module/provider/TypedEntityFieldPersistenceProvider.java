...
import com.ultracommerce.openadmin.server.service.persistence.module.provider.DefaultFieldPersistenceProvider;
 ...
 */
@Component("ucTypedEntityFieldPersistenceProvider")
@Scope("prototype")
