 ...
 */
@Component("ucAdminLogoutSuccessHandler")
public class UltraAdminLogoutSuccessHandler extends AbstractAuthenticationTargetUrlRequestHandler implements LogoutSuccessHandler {
