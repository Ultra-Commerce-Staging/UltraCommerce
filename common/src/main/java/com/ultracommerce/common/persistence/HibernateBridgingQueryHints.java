 ...
 *
 * <p>
 * This class should only be used if you need Hibernate 4.1 (Ultra 5.2 and below) and Hibernate 5.2 (Ultra 6.0+)
 * within the same artifact. This is a stop-gap solution to prevent hard-dependency upgrades within the Ultra platform
 * and is not intended to be consumed by Ultra users.
 *
...
public class HibernateBridgingQueryHints {
    ...
    /**
     * All constants within this inner class only appear in Hibernate 5.2+ (Ultra 6.0+) and
