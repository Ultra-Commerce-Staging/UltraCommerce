...
import com.ultracommerce.common.persistence.IdOverrideTableGenerator;
import com.ultracommerce.common.util.UCFieldUtils;
import com.ultracommerce.common.util.dao.DynamicDaoHelperImpl;
import com.ultracommerce.openadmin.server.service.DynamicEntityRemoteService;
...
public class SessionFactoryChangeListener implements SessionFactoryObserver {
    ...
    public void sessionFactoryCreated(SessionFactory factory) {
        synchronized (DynamicDaoHelperImpl.LOCK_OBJECT) {
            ...
            UCFieldUtils.FIELD_CACHE.clear();
            try {
