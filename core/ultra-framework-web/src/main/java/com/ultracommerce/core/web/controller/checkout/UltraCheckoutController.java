...
import com.ultracommerce.core.checkout.service.gateway.PassthroughPaymentConstants;
 ...
 */
public class UltraCheckoutController extends AbstractCheckoutController {

    private static final Log LOG = LogFactory.getLog(UltraCheckoutController.class);
