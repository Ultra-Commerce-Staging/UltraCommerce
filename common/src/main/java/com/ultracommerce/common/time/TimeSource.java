 ...
 * #L%
 */
package com.ultracommerce.common.time;

/**
 * Provides an abstraction from the current system time.
 * Certain aspects of Ultra can be run in a mode that allows the end user to override the
 * current time.
 *
 ...
 *
 * See UltraProcessURLFilter for example usage of this construct.
 */
